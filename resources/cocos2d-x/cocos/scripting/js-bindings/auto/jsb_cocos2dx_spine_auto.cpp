...
static bool js_cocos2dx_spine_SkeletonRenderer_changeSlot(se::State& s)
{
    spine::SkeletonRenderer* cobj = (spine::SkeletonRenderer*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_spine_SkeletonRenderer_changeSlot : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 6) {
        std::string arg0 = args[0].toStringForce().c_str();
        cocos2d::middleware::Texture2D *arg1;
        cocos2d::renderer::Rect arg2;
        cocos2d::Size arg3;
        cocos2d::Vec2 arg4;
        bool arg5;
        ok &= seval_to_native_ptr(args[1], &arg1);
        // SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_SkeletonRenderer_changeSlot : 1");
        ok &= seval_to_Rect(args[2], &arg2);
        // SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_SkeletonRenderer_changeSlot : 2");
        ok &= seval_to_Size(args[3], &arg3);
        // SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_SkeletonRenderer_changeSlot : 3");
        ok &= seval_to_Vec2(args[4], &arg4);
        // SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_SkeletonRenderer_changeSlot : 4");
        ok &= seval_to_boolean(args[5], &arg5);
        // SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_SkeletonRenderer_changeSlot : 5");

        SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_SkeletonRenderer_changeSlot : Error param");
        cobj->changeSlot(arg0,arg1,arg2,arg3,arg4,arg5), &s.rval();
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 6);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_spine_SkeletonRenderer_changeSlot)
...
bool js_register_cocos2dx_spine_SkeletonRenderer(se::Object* obj)
{
    ...
    cls->defineFunction("changeSlot", _SE(js_cocos2dx_spine_SkeletonRenderer_changeSlot));
...
static bool js_cocos2dx_spine_SkeletonCacheAnimation_changeSlot(se::State& s)
{
    spine::SkeletonCacheAnimation* cobj = (spine::SkeletonCacheAnimation*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_spine_SkeletonCacheAnimation_changeSlot : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 6) {
        ...
        bool arg5;
        ok &= seval_to_native_ptr(args[1], &arg1);
        // SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_SkeletonCacheAnimation_changeSlot : 1");
        ok &= seval_to_Rect(args[2], &arg2);
        // SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_SkeletonCacheAnimation_changeSlot : 2");
        ok &= seval_to_Size(args[3], &arg3);
        // SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_SkeletonCacheAnimation_changeSlot : 3");
        ok &= seval_to_Vec2(args[4], &arg4);
        // SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_SkeletonCacheAnimation_changeSlot : 4");
        ok &= seval_to_boolean(args[5], &arg5);
        // SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_SkeletonCacheAnimation_changeSlot : 5");

        SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_SkeletonCacheAnimation_changeSlot : Error param");
        cobj->changeSlot(arg0,arg1,arg2,arg3,arg4,arg5), &s.rval();
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 6);
...
SE_BIND_FUNC(js_cocos2dx_spine_SkeletonCacheAnimation_changeSlot)
...
bool js_register_cocos2dx_spine_SkeletonCacheAnimation(se::Object* obj)
{
    ...
    cls->defineFunction("changeSlot", _SE(js_cocos2dx_spine_SkeletonCacheAnimation_changeSlot));
